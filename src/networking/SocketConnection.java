...
/**
 * Wrapper for a Socket and implements
 * reading messages that consist of a single line from the socket.
...
public abstract class SocketConnection {
     ...
     */
    private void receiveMessages() { //read data from the socket
        handleStart();
        try {
            String inputLine;
...
//            System.out.println("Runtime exceptions");
    ...
    protected void close() {
        try {
            // the way TCP works, the other side will receive a close event,
            // and will then close the socket
